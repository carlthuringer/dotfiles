...
* Base Editing Tweaks
  ...
  I do like auto-save on lost focus.
   ...
   #+BEGIN_SRC elisp
     ...
     (add-hook 'focus-out-hook 'ct/save-all)
   #+END_SRC
   ...
   And finally set a nice dark theme.
...
* Package Manager
  ...
  #+BEGIN_SRC elisp
    (defvar ct/packages '(org
                          auto-package-update) "Default Packages")
  #+END_SRC
...
* Fill Mode
  ...
  This is the first annoyance that I find when I'm writing in Org. I
  really like it to automatically wrap my columns and indent for me,
  but org doesn't do that for me. As a remedy for constantly needing
  to hit =M-q= I can use Fill Mode instead.
